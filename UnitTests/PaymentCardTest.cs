...
public class PaymentCardTest
{
    ...
    public void PaymentCardNameSetIsSuccessfulIfNameIsValid()
    {
        ...
        var paymentCard = new PaymentCardTesting("card", "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), 10f);
    ...
    public void PaymentCardNameSetThrowsArgumentExceptionIfNameIsInvalid(string name) =>
        Assert.Throws<ArgumentException>(() =>
            new PaymentCardTesting(name, "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), 10f));
    ...
    public void PaymentCardNumberSetThrowsArgumentExceptionIfNumberIsInvalid(string number) =>
        Assert.Throws<ArgumentException>(() =>
            new PaymentCardTesting("my card", number, 222, UserInfoHelper.GetDefaultUserInfo(), 10f));
    ...
    [InlineData(22)]
    [InlineData(4444)]
    public void PaymentCardCVVSetThrowsArgumentExceptionIfCVVIsInvalid(int CVV) => Assert.Throws<ArgumentException>(
        () => new PaymentCardTesting("my card", "1111111111111111", CVV, UserInfoHelper.GetDefaultUserInfo(), 10f));
    ...
    public void PaymentCardUserInfoThrowsArgumentExceptionIfUserInfoIsNull() =>
        Assert.Throws<ArgumentNullException>(() => new PaymentCardTesting("my card", "1111111111111111", 111, null, 10f));
    ...
    public void PaymentCardToStringReturnsValidResult()
    {
        ...
        var paymentCard = new PaymentCardTesting(name, cardNumber, CVV, userInfo, balance);
