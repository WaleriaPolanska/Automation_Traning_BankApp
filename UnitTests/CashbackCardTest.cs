...
public class CashbackCardTest
{
    ...
    public void CashbackCardInterestSetIsSuccessfulIfInterestIsValid()
    {
        ...
        var cashbackCard =
            new CashbackCard("card", "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), 4f, 1000f);
    ...
    [Fact]
    public void CashbackCardInterestSetThrowsArgumentExceptionIfInterestIsInvalid() => Assert.Throws<ArgumentException>(
        () => new CashbackCard("card", "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), -1f, 4444f));
    ...
    public void CashbackCardMakePaymentIsSuccessful()
    {
        ...
        var cashbackCard =
            new CashbackCard("card", "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), 4f, 6000f);
    ...
    public void CashbackCardTopUpIsSuccessful()
    {
        ...
        var cashbackCard =
            new CashbackCard("card", "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), 4f, 0f);
