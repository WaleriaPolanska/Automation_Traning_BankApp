...
public class DebitCardTest
{
    ...
    [Fact]
    public void DebitCardInterestSetThrowsArgumentExceptionIfInterestIsInvalid() => Assert.Throws<ArgumentException>(
        () => new DebitCard("card", "1111111111111111", 222, UserInfoHelper.GetDefaultUserInfo(), -1.1f, 4444f));
